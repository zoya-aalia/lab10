...
if (session.getAttribute("authenticatedUser") != null) {
    ...
    %>
    <div style="background-image: linear-gradient(to left, #769d6d, #344f2e); padding:10px;">
        ...
        <a href="logout.jsp" style="margin-left:990px">Sign Out</a>
        <a href="customer.jsp" style="margin-left:20px"><%= userName %></a>
